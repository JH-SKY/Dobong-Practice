...
* **sns-service-db-design/** : SNS 데이터베이스 설계 프로젝트 루트
    ...
    * **docs/**
        * **diagrams/** : 원본 설계 파일 보관
            * `sns_erd_v1.1.drawio` : 팔로우/해시태그 추가 설계 원본
            * `sns_erd_v1.2.drawio` : 알림/채팅 확장 설계 원본
            * `sns_erd_v2.0.drawio` : 최종 고도화 설계 원본
        * **images/** : 설계 이력 이미지 보관
            * `sns_erd_v1.1.png` : 팔로우/해시태그 추가안
            * `sns_erd_v1.2.png` : 채팅 확장 및 알림 시스템 설계안
            * `sns_erd_v2.0.png` : 최종 고도화 설계 이미지
    * `README.md` : 프로젝트 상세 명세 및 업데이트 기록 (본 파일)

![최종 ERD](docs/images/sns_erd_v2.0.png)
